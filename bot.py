...
async def upspe(client: Client, message: Message):	
	...
	if comprobacion_de_user(username) == False:
		...
		await send("✅ UPSPE API Client Upload Activate")
		try:
			await send_config()
		except:
			pass
		return
@bot.on_message(filters.command("medisur", prefixes="/") & filters.private)
		...
		if filename.split(".")[-1]=="txt":
			...
			if "medisur.sld.cu" in urls[0]:
				...
				async with aiohttp.ClientSession(connector=connector) as session:
					...
					async with session.post(host+"index.php?P=UserLogin", data=payload) as e:
						print(222)
					for url in urls:
						try:
							url_id = url.split(">")[1]
			...
			if filesize-1048>zipssize:
				...
				for file in files:
					try:
						...
						payload["Submit"] = "Cargar"
						payload["F_Description"] = ""
						payload["F_Tipodetesis[]"] = ""
						payload["F_Provincia[ ]"] = ""
						payload["F_Anodedefensadelatesis"] = ""
						payload["F_Tutor1"] = ""
						payload["F_Tutor2"] = ""
						payload["F_Tutor3"] = ""
						payload["F_Tutor4"] = ""
						...
						payload["F_ISBN"] = ""
						payload["F_Editorial"] = ""
						payload["F_Tipodefecha"] = ""
						payload["F_UrlOficial"] = ""
						payload["F_Materia[]"] = ""
						payload["F_Listadescriptores[ ]"] = ""
						payload["F_Numerodelaresolucion"] = ""
						payload["F_Anoresolucion"] = ""
						payload["F_InformacionAdicional"] = ""
						payload["F_TextoCompleto"] = ""
						payload["F_TextoCompletoLimpiar"] = ""
						payload["Textorestringido"] = "application/octet-stream"
